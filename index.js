...
const __filename = fileURLToPath(import.url);
...
// Configuration
const apikey = 'ptla_lQci5AhFhW28Egif2fN04dgPgDi7T9wfHX4EcxX0NmS';
const capikey = 'ptlc_yUYlFrWSEy6wdUie1Sv8KZlH7U4MESHuADKFqqCuRLU';
const domain = 'https://mypanelll.pteroq.xyz';
const nestid = '5';
const egg = '15';
const loc = '1';
const gmailadmin = 'clara@admin.com'; // Admin email that won't be deleted
const telegramBotToken = '7326530926:AAGwc6KRYF8PJVmp3lHVLsoEq8MtIpjt7t4';
const adminTelegramId = '7277892050';
...
app.post('/api/login', (req, res) => {
  ...
  if (username === 'clara' && password === 'clara117') {
    res.json({ success: true, user: { username: 'clara', role: 'admin' } });
  } else {
